...
class FacebookOAuthService extends EOAuth2Service {
	...
	protected function fetchAttributes() {
        ...
        $this->attributes['info'] = (array)$info;
		$this->attributes['id'] = $info->id;
		$this->attributes['name'] = $info->name;
        $this->attributes['firstname'] = $info->first_name;
        $this->attributes['lastname'] = $info->last_name;
        $this->attributes['nickname'] = $info->username;
        $this->attributes['birth_date'] = DateTime::createFromFormat('d/m/Y',$info->birthday)->format('Y-m-d');
        $this->attributes['is_male'] = $info->gender=='male';
