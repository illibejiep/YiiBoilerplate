...
abstract class BaseGiiyPicture extends GiiyActiveRecord implements ITypeEnumerable {
	...
	public function tableName() {
		return Yii::app()->getModule('giiy')->tablePrefix.'giiy_picture';
	}
	...
	public function relations() {
		return array(
			'videos' => array(self::HAS_MANY, 'GiiyVideo', 'picture_id'),
		);
	}
    ...
    public function getType() {
        ...
        if ($this->_type === null)
            $this->_type = new GiiyPictureTypeEnum($this->getAttribute('type_enum'));

        return $this->_type;
    }

    public function setType($value) {
        if ($value instanceof GiiyPictureTypeEnum) {
            $this->_type = $value;
            $this->setAttribute('type_enum', $value->id);
        } elseif (is_numeric($value)) {
            $this->_type = new GiiyPictureTypeEnum($value);
    ...
    {
        $typesFields = array();
        foreach (GiiyPictureTypeEnum::$names as $id => $name) {
