	...
	public function actionRecovery ($email = '', $key = '') {
		...
		if (Yii::app()->user->id) {
            ...
            if ($email && $key) {
                ...
                if(isset($find)&&$find->activkey==$key) {
                ...
                if(isset($_POST['UserRecoveryForm'])) {
                    ...
                    if($form->validate()) {
                        ...
                        $activation_url = 'http://' . $_SERVER['HTTP_HOST'].$this->createUrl(Yii::app()->controller->module->recoveryUrl,array("key" => $user->activkey, "email" => $user->email));
